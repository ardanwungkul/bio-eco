<div id="facebook" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between px-4 py-2 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="facebook" data-modal-target="addSocmed" data-modal-toggle="addSocmed">
            ...
            <div class="p-6 space-y-2">
                <div>
                    <input type="url" placeholder="URL" name="facebook" onblur="convertToHttps(this)"
                        onclick="clearOtherInputs('facebook')"
