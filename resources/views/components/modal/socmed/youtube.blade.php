<div id="youtube" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between px-4 py-2 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="youtube" data-modal-target="addSocmed" data-modal-toggle="addSocmed">
            ...
            <div class="p-6 space-y-2">
                <div>
                    <input type="url" placeholder="URL" name="youtube" onblur="convertToHttps(this)"
                        onclick="clearOtherInputs('youtube')"
